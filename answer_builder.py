...
Do not use rich-text formatting markers inside code unless they
are actually part of the code.
...
Provide a direct, relevant, natural, accurate, well-structured,
and useful answer to the user's current request.
""".strip()
)
